...
#ifndef SMART_SZX_INCREMENTAL_GRAPH_DRAWING_COMMON_H
#define SMART_SZX_INCREMENTAL_GRAPH_DRAWING_COMMON_H
...
#endif // SMART_SZX_INCREMENTAL_GRAPH_DRAWING_COMMON_H
