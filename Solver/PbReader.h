...
#ifndef SMART_SZX_INCREMENTAL_GRAPH_DRAWING_PB_READER_H
#define SMART_SZX_INCREMENTAL_GRAPH_DRAWING_PB_READER_H
...
#endif // SMART_SZX_INCREMENTAL_GRAPH_DRAWING_PB_READER_H
