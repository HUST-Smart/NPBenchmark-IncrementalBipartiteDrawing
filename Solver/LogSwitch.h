...
#ifndef SMART_SZX_INCREMENTAL_GRAPH_DRAWING_LOG_SWITCH_H
#define SMART_SZX_INCREMENTAL_GRAPH_DRAWING_LOG_SWITCH_H
...
#endif // SMART_SZX_INCREMENTAL_GRAPH_DRAWING_LOG_SWITCH_H
