...
#ifndef SMART_SZX_INCREMENTAL_GRAPH_DRAWING_CONFIG_H
#define SMART_SZX_INCREMENTAL_GRAPH_DRAWING_CONFIG_H
...
#endif // SMART_SZX_INCREMENTAL_GRAPH_DRAWING_CONFIG_H
